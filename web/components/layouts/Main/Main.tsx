  ...
  return (
    <>
      <Head>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href="/img/favicon/apple-icon-57x57.png?v=cn1" />
        <link rel="apple-touch-icon" sizes="60x60" href="/img/favicon/apple-icon-60x60.png?v=cn1" />
        <link rel="apple-touch-icon" sizes="72x72" href="/img/favicon/apple-icon-72x72.png?v=cn1" />
        <link rel="apple-touch-icon" sizes="76x76" href="/img/favicon/apple-icon-76x76.png?v=cn1" />
        <link
          rel="apple-touch-icon"
          sizes="114x114"
          href="/img/favicon/apple-icon-114x114.png?v=cn1"
        />
        <link
          rel="apple-touch-icon"
          sizes="120x120"
          href="/img/favicon/apple-icon-120x120.png?v=cn1"
        />
        <link
          rel="apple-touch-icon"
          sizes="144x144"
          href="/img/favicon/apple-icon-144x144.png?v=cn1"
        />
        <link
          rel="apple-touch-icon"
          sizes="152x152"
          href="/img/favicon/apple-icon-152x152.png?v=cn1"
        />
        <link
          rel="apple-touch-icon"
          sizes="180x180"
          href="/img/favicon/apple-icon-180x180.png?v=cn1"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="192x192"
          href="/img/favicon/android-icon-192x192.png?v=cn1"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href="/img/favicon/favicon-32x32.png?v=cn1"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="96x96"
          href="/img/favicon/favicon-96x96.png?v=cn1"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="/img/favicon/favicon-16x16.png?v=cn1"
        />
        <link rel="manifest" href="/manifest.json" />
        <link rel="authorization_endpoint" href="/api/auth/provider/indieauth" />
        <meta name="msapplication-TileColor" content="#15181c" />
        <meta name="msapplication-TileImage" content="/img/favicon/ms-icon-144x144.png?v=cn1" />
        <meta
          name="viewport"
