...
type ServerInterface interface {
	...
	// Begin an OIDC chat-auth flow (SGC fork extension)
	// (POST /auth/oidc)
	StartOIDCAuthFlow(w http.ResponseWriter, r *http.Request, params StartOIDCAuthFlowParams)
...
// Begin an OIDC chat-auth flow (SGC fork extension)
// (POST /auth/oidc)
func (_ Unimplemented) StartOIDCAuthFlow(w http.ResponseWriter, r *http.Request, params StartOIDCAuthFlowParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// StartOIDCAuthFlow operation middleware
func (siw *ServerInterfaceWrapper) StartOIDCAuthFlow(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params StartOIDCAuthFlowParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.StartOIDCAuthFlow(w, r, params)
	}))
...
// HandleOIDCRedirect operation middleware
func (siw *ServerInterfaceWrapper) HandleOIDCRedirect(w http.ResponseWriter, r *http.Request) {

	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params HandleOIDCRedirectParams
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.HandleOIDCRedirect(w, r, params)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/auth/oidc", wrapper.StartOIDCAuthFlow)
	})
	r.Group(func(r chi.Router) {
