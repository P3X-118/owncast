...
// StartOIDCAuthFlowParams defines parameters for StartOIDCAuthFlow.
type StartOIDCAuthFlowParams struct {
	AccessToken AccessToken `form:"accessToken" json:"accessToken"`
}

// HandleOIDCRedirectParams defines parameters for HandleOIDCRedirect.
type HandleOIDCRedirectParams struct {
	// State Opaque state token issued by Owncast at flow start
	State string `form:"state" json:"state"`

	// Code OIDC authorization code returned by the provider on success
	Code *string `form:"code,omitempty" json:"code,omitempty"`

	// Error OAuth2 error code returned by the provider on failure
